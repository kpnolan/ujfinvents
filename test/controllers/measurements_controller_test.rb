...
class MeasurementsControllerTest < ActionController::TestCase
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post :create, measurement: { device: @measurement.device, label: @measurement.label, ts_taken: @measurement.ts_taken }
    end
  ...
  test "should update measurement" do
    patch :update, id: @measurement, measurement: { device: @measurement.device, label: @measurement.label, ts_taken: @measurement.ts_taken }
    assert_redirected_to measurement_path(assigns(:measurement))
  end
