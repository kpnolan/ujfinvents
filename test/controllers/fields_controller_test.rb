...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { name: @field.name, num_columns: @field.num_columns, num_rows: @field.num_rows }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { name: @field.name, num_columns: @field.num_columns, num_rows: @field.num_rows }
    assert_redirected_to field_path(assigns(:field))
  end
